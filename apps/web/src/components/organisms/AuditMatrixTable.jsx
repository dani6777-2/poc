  ...
  return (
    <Card className="overflow-hidden shadow-premium border-none">
      <div className="p-6 md:p-12 border-b border-border-base bg-tx-primary/[0.01]">
        ...
        <p className="text-[10px] font-bold text-tx-muted uppercase tracking-widest mt-2 opacity-30">
          Validation criteria applied to global sustainability analysis
        </p>
      </div>
                  ...
                  <td className="p-5 md:p-8 pl-14">
                    <div className="flex items-center gap-5 md:p-8">
                      ...
                      <div className="flex flex-col">
                        <span className="text-base font-black text-tx-primary uppercase tracking-widest">
                          {s.section}
                        </span>
                        <Badge
                          variant="muted"
                          size="sm"
                          className="w-fit mt-2 opacity-30 font-black text-[8px] tracking-[0.2em]"
                        >
                          ISO_SAFE_302
                        </Badge>
                      </div>
      ...
      <footer className="p-6 md:p-12 border-t border-border-base flex flex-col md:flex-row justify-between items-center opacity-30 hover:opacity-100 transition-all group/footer">
        ...
        <div className="mt-10 md:mt-0 flex flex-col items-end gap-1">
          <p className="text-[11px] font-black text-tx-primary uppercase tracking-[0.4em] leading-none">
            Enterprise Platform v4.5
          </p>
          <p className="text-[9px] font-bold text-tx-muted uppercase tracking-[0.2em] mt-1">
            Deepmind Agentic Coding Core
          </p>
        </div>
      </footer>
    </Card>
