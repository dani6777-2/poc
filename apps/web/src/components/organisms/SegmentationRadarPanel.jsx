    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:p-8">
        ...
        {data?.channels?.length > 0 ? (
          ...
          <div className="py-20 flex flex-col items-center justify-center text-center opacity-20 gap-4 grayscale">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest leading-loose">
              No processed transactions <br /> by integrated channels
            </p>
          </div>
        )}
      </Card>
      ...
      <Card className="p-5 md:p-8 space-y-8 relative overflow-hidden shadow-premium border border-border-base">
        ...
        <div>
          ...
          <p className="text-[10px] text-tx-muted font-bold uppercase mt-1 opacity-40 tracking-wider">
            Historical deviation metric in consumption assets
          </p>
        </div>
        ...
        {data?.inflation?.length > 0 ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center opacity-20 gap-5 grayscale pt-10">
            <div className="w-12 h-12 rounded-full border border-border-base flex items-center justify-center text-xl shadow-inner">
              📡
            </div>
            <p className="text-[9px] font-black uppercase tracking-[0.3em] max-w-[240px] text-center leading-relaxed">
              Insufficient historical reference <br /> for inflationary radar
            </p>
          </div>
        )}
      </Card>
