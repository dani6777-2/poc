...
const RevenueMatrixTable = ({
  ...
  return (
    <Card className="overflow-hidden shadow-premium border-none">
      <div className="p-6 lg:p-10 border-b border-border-base flex items-center justify-between bg-border-base/5">
        ...
        <table className="w-full text-left border-collapse min-w-[1500px]">
          <thead className="sticky top-0 z-20">
            <tr className="border-b border-border-base/60 shadow-premium">
              <th className="p-5 md:p-8 text-[10px] font-black uppercase tracking-[0.4em] text-tx-muted sticky left-0 z-30 bg-secondary/95 backdrop-blur-xl border-r border-border-base/40">
                Revenue Source
              </th>
              {MONTH_LABELS.map((m) => (
                <th
              ...
              <th className="p-5 md:p-8 text-[10px] font-black uppercase tracking-[0.4em] text-accent-light text-right bg-tx-primary/[0.04] backdrop-blur-xl">
                Consolidated Annual
              </th>
              <th className="w-16 p-5 md:p-8 bg-tx-primary/[0.04] backdrop-blur-xl"></th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border-base">
            {loading ? (
              ...
              <tr>
                ...
                >
                  <div className="flex flex-col items-center gap-5 md:p-8 opacity-20 grayscale">
          ...
          {rows.length > 0 && (
            <tfoot className="sticky bottom-0 z-30 shadow-premium">
              <tr className="bg-secondary/95 backdrop-blur-xl border-t border-border-base/60 h-28">
                <td className="p-5 md:p-8 font-black text-[11px] uppercase tracking-[0.5em] text-tx-muted sticky left-0 z-30 bg-secondary/95 border-r border-border-base/40">
                  ANNUALIZED TOTAL
                </td>
                ...
                <td className="p-5 md:p-8 text-right font-black text-[28px] text-success drop-shadow-glow-success tabular-nums tracking-tighter bg-tx-primary/[0.04] border-l border-border-base/60 underline decoration-success/20 underline-offset-[12px] decoration-4">
                  {fmt(totalAnnual)}
                </td>
