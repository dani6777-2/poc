    ...
    <>
      ...
      {nodataSecs.length > 0 && (
        <details className="card p-0 overflow-hidden transition-all duration-500 group border-none shadow-premium opacity-50 hover:opacity-100 bg-tx-primary/[0.01]">
          <summary className="p-6 lg:p-10 cursor-pointer list-none flex items-center justify-between hover:bg-tx-primary/[0.02]">
          ...
          <div className="p-6 md:p-12 pt-6 grid grid-cols-1 md:grid-cols-3 gap-6 lg:p-10 animate-in slide-in-from-top-4">
            {nodataSecs.map((s) => (
              <SectionHealthCard key={s.section} sec={s} />
            ))}
          </div>
